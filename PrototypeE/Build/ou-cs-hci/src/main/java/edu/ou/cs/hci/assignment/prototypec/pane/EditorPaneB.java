 ...
 * @version %I%, %G%
 */
public final class EditorPaneB extends AbstractPane
{
	//**********************************************************************
	...
	public EditorPaneB(Controller controller)
	{
	...
	private void	updateMoviePropertiesInModel()
	{
		...
		// DONE #3: Update the other 13 properties, summary, and comments below
		controller.set("movie.year", movie.getYear());
		controller.set("movie.rating", rdata.indexOf(movie.getRating()));
		...
		controller.set("movie.award.cinematography",
					   movie.getAwardCinematography());
		controller.set("movie.award.acting", movie.getAwardActing());

		controller.set("movie.averageReviewScore",
					   movie.getAverageReviewScore());
