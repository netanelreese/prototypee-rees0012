...
package edu.ou.cs.hci.assignment.prototypee;
...
import javafx.stage.*;
import edu.ou.cs.hci.assignment.prototypee.pane.*;
...
public final class View
{
	...
	private static final double	SCENE_W = 1080;	// Scene width
	private static final double	SCENE_H = 540;		// Scene height

	// Adjusted w and h to match the About Pane from Design D
	private static final double	ABOUT_W = 350;		// About Pane width
	...
	private void	buildAboutStage()
	{
		...
		// Changed the pane background color to match the about page.
		pane.setStyle("-fx-background-color: #fffff0;");
