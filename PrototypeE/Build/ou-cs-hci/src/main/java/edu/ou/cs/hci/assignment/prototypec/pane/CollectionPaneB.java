 ...
 * @version %I%, %G%
 */
public final class CollectionPaneB extends AbstractPane
{
	//**********************************************************************
	...
	public CollectionPaneB(Controller controller)
	{
	...
	public void	initialize()
	{
		...
		// Initialize summary widgets here, using model properties
	...
	public void	terminate()
	{
		...
		// Terminate summary widgets here
		// Nothing to do!
	}
	...
	public void	update(String key, Object value)
	{
		if ("selectedMovieIndex".equals(key))
		{
			...
			// Update summary widgets here, using movie attributes
			populateSummary(index);
		}
	}

	private void	populateSummary(int index)
	{
	...
	// This Callback creates properties for values of the isAnimated
	// attribute. See the CheckBoxTableCell API for how this works.
		...
		implements Callback<Integer, ObservableValue<Boolean>>
	{
		public ObservableValue<Boolean>	call(Integer v)
		{
			...
			// CheckBoxes don't keep changes when they redraw! If only
			// Movie returned its actual properties for binding...
			return new SimpleBooleanProperty(movie.getIsAnimated());
		}
	}
	...
	// This EventHander processes edits in the score column.
	...
	// This EventHander processes edits in the genre column.
